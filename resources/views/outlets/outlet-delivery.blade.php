                    ...
                    <div class="col-12 col-sm-8 p-15">
                        <form id="save-outlet" method="POST" action="{!! env('APP_URL') !!}save/features/outlet" enctype="multipart/form-data">
                            ...
                            <div class="p-15">
                                ...
                                <div class="row">
                                    <div id="main" @if($outlet->is_delivery=="1") class="active p-0" @endif>
                                        ...
                                        $existing_days = \App\Models\BranchHours::where('branch_id',$outlet->id)->where('hours_for','delivery')->get();
                                        $day_exists = [];
                                        ...
                                        @if(isset($existing_days) && $existing_days->count() > 0)
                                            @foreach($existing_days as $d)
                                                <div class="row mb-3 hour-section">
                                                    <div class="col-sm-2"> @if(!in_array($d->day_name,$day_exists)){{__('label.'.trim(strtolower($d->day_name)))}}@endif</div>
                                        ...
                                        <figure>
                                            <blockquote class="blockquote">
                                                <p>{{__('label.estimated_time_settings')}}</p>
                                            </blockquote>
