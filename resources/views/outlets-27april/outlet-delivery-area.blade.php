                    ...
                    <div class="col-12">
                        <div class="box">
                            <div class="box-header with-border">
                                @if(isset($outlet))
                                    <h4 class="box-title">Update {!! $outlet->name !!}</h4>
                                @else
                                ...
                                <div class="tab-content" style="width: 84%">
                                    <div class="tab-pane active" id="basic-information" role="tabpanel" style="position: relative">
                                        <div class="delivery-section">
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label>Delivery area name </label>
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <button class="btn btn-primary save-delivery-area">Save Delivery Area</button>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
