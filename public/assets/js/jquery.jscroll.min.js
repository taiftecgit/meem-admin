...
!function (m) {
    ...
    var l = function (a, t) {
        var n, e = a.data("jscroll"), l = "function" == typeof t ? {callback: t} : t,
            s = m.extend({}, m.jscroll.defaults, l, e || {}), d = "visible" === a.css("overflow-y"),
            o = a.find(s.nextSelector).first(), r = m(window), i = m("body"), f = d ? r : a,
            c = m.trim(o.prop("href") + " " + s.contentSelector), g = function () {
                ...
                if (a.is(":visible")) {
                    g();
                    var t = a.find("div.jscroll-inner").first(), n = a.data("jscroll"),
                        e = parseInt(a.css("borderTopWidth"), 10), l = isNaN(e) ? 0 : e,
                        o = parseInt(a.css("paddingTop"), 10) + l, r = d ? f.scrollTop() : a.offset().top,
                        i = t.length ? t.offset().top : 0, c = Math.ceil(r - i + f.height() + o);
                ...
                var t = a.find("div.jscroll-inner").first(), r = a.data("jscroll");
        ...
        return a.data("jscroll", m.extend({}, e, {
            ...
            waiting: !1,
            nextHref: c
        })), g(), (n = m(s.loadingHtml).filter("img").attr("src")) && ((new Image).src = n), h(), m.extend(a.jscroll, {destroy: p}), a
    };
    m.fn.jscroll = function (e) {
        return this.each(function () {
            var t = m(this), n = t.data("jscroll");
