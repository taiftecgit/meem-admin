...
@endphp 
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="time_zone" class="form-control" required>
                                        ...
                                        $existing_resto_meta = [];
                                        if(isset($outlet))
                                        $existing_resto_meta = \App\RestoMetas::where('bussiness_id',$restaurant->id)->where('outlet_id',$outlet->id)->pluck('meta_def_id')->toArray();
                                       ...
                                       // dump($existing_resto_meta);
                                        ...
                                        $existing_resto_meta_value = null;
                                         if(isset($outlet))
                                        $existing_resto_meta_value = \App\RestoMetas::where('bussiness_id',$restaurant->id)->where('outlet_id',$outlet->id)->get();
                                        $v = [];
