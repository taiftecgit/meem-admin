                                                                 ...
                                                                 <li class="list-group-item"  id="{!! $row_id !!}">
                                                                     ...
                                                                     <div class="d-flex align-content-start flex-wrap">
                                                                         ...
                                                                         <div class="  ms-auto ">
                                                                             ...
                                                                             <a href="{!! env('QRCODE_HOST_ORDER') !!}{!! $item->resto_unique_name !!}/item/{!! $item->unique_shared_key !!}" class="btn btn-sm btn-primary mb-1" target="_blank" data-toggle="tooltip" data-placement="top" title="Direct Link"><i class="  glyphicon glyphicon-paperclip"></i></a>
